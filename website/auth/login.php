...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL) || $password === '') {
        ...
        $stmt = $pdo->prepare('SELECT user_id, first_name, password_hash, is_active, is_admin, is_coach, metadata
        ...
        if (!$user || !password_verify($password, $user['password_hash'])) {
            ...
            $_SESSION['app_role']  = sportsplay_extract_app_role_from_metadata($user['metadata'] ?? null) ?? null;
