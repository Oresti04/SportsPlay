...
function sp_remove_profile_image_file(?string $path): void
{
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_profile') {
        ...
        if (!empty($_POST['remove_profile_image'])) {
            sp_remove_profile_image_file($newImagePath);
            $newImagePath = null;
        }
...
<section class="sp-card">
  <div class="sp-card__hd"><div><div class="sp-card__title">Profile Settings</div><div class="sp-card__sub">Photo, basic info and contact</div></div></div>
  ...
  <section class="sp-card">
    ...
    <div class="sp-card__bd">
      <div class="sp-stack sp-stack--sm">
        ...
        <div class="sp-statline"><span>Card</span><strong>**** **** **** 4821</strong></div>
      ...
      <div class="sp-settings-grid" style="margin-top:12px;">
        <div class="sp-settings-field"><label class="sp-form-label">Card number</label><input class="sp-input" style="width:100%;" placeholder="4242 4242 4242 4242"></div>
